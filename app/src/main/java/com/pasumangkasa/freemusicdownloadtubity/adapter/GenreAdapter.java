...
public class GenreAdapter extends DBRecyclerViewAdapter implements PasumConstants {
    ...
    public GenreAdapter(PasumFragmentActivity mContext, ArrayList<GenreModel> mListObjects, int type) {
