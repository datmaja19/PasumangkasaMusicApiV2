...
public class TrackAdapter extends DBRecyclerViewAdapter implements PasumConstants {
    ...
    public TrackAdapter(PasumFragmentActivity mContext, ArrayList<TrackModel> mListObjects, int type) {
