...
public class PlaylistAdapter extends DBRecyclerViewAdapter implements PasumConstants {
    ...
    public PlaylistAdapter(PasumFragmentActivity mContext, ArrayList<PlaylistModel> mListObjects, View mHeaderView, int typeUI) {
