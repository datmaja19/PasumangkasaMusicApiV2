...
import com.pasumangkasa.freemusicdownloadtubity.adapter.PresetAdapter;
...
import com.pasumangkasa.freemusicdownloadtubity.view.SwitchView;
import com.pasumangkasa.freemusicdownloadtubity.view.VerticalSeekBar;
 ...
 * @Date:Apr 18, 2015
 */
public class PasumEqualizerActivity extends PasumFragmentActivity implements IDBMusicPlayerListener {

    public static final String TAG = PasumEqualizerActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCircularBass.setOnSeekArcChangeListener(new SeekArc.OnSeekArcChangeListener() {
            ...
            public void onProgressChanged(SeekArc seekArc, int progress, boolean fromUser) {
                try{
                    ...
                    if (fromUser) {
                        if (mBassBoost != null) {
                            PasumSettingManager.setBassBoost(PasumEqualizerActivity.this, (short) progress);
                ...
                try{
                    ...
                    if (fromUser) {
                        if (mVirtualizer != null) {
                            PasumSettingManager.setVirtualizer(PasumEqualizerActivity.this, (short) progress);
        ...
        mSwitchBtn.setOncheckListener(check -> {
            PasumSettingManager.setEqualizer(PasumEqualizerActivity.this, check);
            startCheckEqualizer();
        });
            ...
            if (mEqualizer != null) {
                ...
                if (!StringUtils.isEmpty(params)) {
                    ...
                    if (mEqualizerParams != null && mEqualizerParams.length > 0) {
                        ...
                        PasumSettingManager.setEqualizerPreset(this, String.valueOf(mLists.length - 1));
                    }
                }
            }
        }
        ...
        try{
            if (mEqualizer != null) {
                if (bands > 0) {
                    ...
                    PasumSettingManager.setEqualizerPreset(this, String.valueOf(mLists.length - 1));
                    PasumSettingManager.setEqualizerParams(this, data);
                }
            }
        }
        catch (Exception e){
    ...
    private void setupEqualizerFxAndUI(boolean isFirstTime) {
        ...
        if (mEqualizer == null) {
            ...
            mEqualizer.setEnabled(PasumSettingManager.getEqualizer(this));
        }
        try {
        ...
        try {
            if (mBassBoost.getStrengthSupported()) {
                ...
                if (mVirtualizer.getStrengthSupported()) {
                    short mCurrentShort = PasumSettingManager.getBassBoost(this);
                    mBassBoost.setStrength((short) (mCurrentShort * RATE_EFFECT));
                    mBassBoost.setEnabled(PasumSettingManager.getEqualizer(this));

                    short mCurrentVir = PasumSettingManager.getVirtualizer(this);
                    mVirtualizer.setStrength((short) (mCurrentVir * RATE_EFFECT));
                    mVirtualizer.setEnabled(PasumSettingManager.getEqualizer(this));
            ...
            if (numberPreset > 0) {
                ...
                mSpinnerPresents.setOnItemSelectedListener(new OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        PasumSettingManager.setEqualizerPreset(PasumEqualizerActivity.this, String.valueOf(position));
                        try{
