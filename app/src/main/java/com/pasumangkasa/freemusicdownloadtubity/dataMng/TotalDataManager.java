...
import com.pasumangkasa.freemusicdownloadtubity.PasumFragmentActivity;
...
import com.pasumangkasa.freemusicdownloadtubity.model.UserModel;
import com.pasumangkasa.freemusicdownloadtubity.setting.PasumSettingConstants;
...
public class TotalDataManager implements PasumConstants, PasumSettingConstants {
    ...
    public synchronized void addTrackToPlaylist(final PasumFragmentActivity mContext, final TrackModel mParentTrackObject,
                                                final PlaylistModel mPlaylistObject, boolean isShowMsg, final PasumCallback mCallback) {
    ...
    public synchronized boolean removeTrackToPlaylistNoThread(TrackModel mTrackObject
            , PlaylistModel mPlaylistObject, PasumCallback mCallback, boolean isNeedSave) {
    ...
    public synchronized void removeTrackToPlaylist(final TrackModel mTrackObject
            , final PlaylistModel mPlaylistObject, final PasumCallback mCallback) {
        DBExecutorSupplier.getInstance().forBackgroundTasks().execute(() -> {
    ...
    public void readConfigure(Context mContext) {
        ...
        if(configureModel!=null){
            PasumSettingManager.setBackground(mContext,configureModel.getBg());
        }
    }
