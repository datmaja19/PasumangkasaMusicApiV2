package com.pasumangkasa.freemusicdownloadtubity.constants;


import com.pasumangkasa.freemusicdownloadtubity.PasumSplashActivity;

public interface PasumConstants {
	
	public static final boolean DEBUG = false;

	public static final String ANDROID8_CHANNEL_ONE_NAME = "MusicChannel";//you can change the channel name for android 8.0
...
//	public static final String SOUND_CLOUD_CLIENT_ID = "NmW1FlPaiL94ueEu7oziOWjYEzZzQDcK";
...
//	public static final String ADMOB_APP_ID = "ADMOB_APP_ID";
	...
	public static final String SOUND_CLOUD_CLIENT_ID = "f0sxU3Az3dcl0lS1M9wFJ00SqawVL72n";
	public static final String ADMOB_BANNER_ID = String.valueOf(PasumSplashActivity.id_banner);
	public static final String ADMOB_INTERSTITIAL_ID = String.valueOf(PasumSplashActivity.id_inter);
	public static final String ADMOB_APP_ID = String.valueOf(PasumSplashActivity.admob_id);
	public static final String DIR_CACHE = "music_app";

	public static final boolean SHOW_SOUND_CLOUD_TAB = true; //enable sound cloud tab

	public static final String URL_WEBSITE = "";
	public static final String YOUR_CONTACT_EMAIL = "support@pasumangkasa.com";
	...
	public static final String ADMOB_TEST_DEVICE = "c661eaa1-29a0-487f-a9ad-10ca1ad1abe1";
