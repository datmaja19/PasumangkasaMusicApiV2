...
public class PasumRemoteControlClientCompat {

	private static final String TAG = PasumRemoteControlClientCompat.class.getSimpleName();
	...
	static {
		try {
			ClassLoader classLoader = PasumRemoteControlClientCompat.class.getClassLoader();
			...
			// change
			// in future versions.
			for (Field field : PasumRemoteControlClientCompat.class.getFields()) {
				try {
	...
	public PasumRemoteControlClientCompat(PendingIntent pendingIntent) {
	...
	public PasumRemoteControlClientCompat(PendingIntent pendingIntent, Looper looper) {
		if (!sHasRemoteControlAPIs) {
			return;
		}
