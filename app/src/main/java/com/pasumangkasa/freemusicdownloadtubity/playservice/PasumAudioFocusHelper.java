...
public class PasumAudioFocusHelper implements AudioManager.OnAudioFocusChangeListener {

	private AudioManager mAM;
	private PasumMusicFocusableListener mFocusable;

	public PasumAudioFocusHelper(Context ctx, PasumMusicFocusableListener focusable) {
