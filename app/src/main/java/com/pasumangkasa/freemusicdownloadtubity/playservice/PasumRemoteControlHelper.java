...
public class PasumRemoteControlHelper {
	private static final String TAG = "PasumRemoteControlHelper";
	...
	static {
		try {
			ClassLoader classLoader = PasumRemoteControlHelper.class.getClassLoader();
			Class sRemoteControlClientClass = PasumRemoteControlClientCompat.getActualRemoteControlClientClass(classLoader);
	...
	public static void registerRemoteControlClient(AudioManager audioManager, PasumRemoteControlClientCompat remoteControlClient) {
	...
	public static void unregisterRemoteControlClient(AudioManager audioManager, PasumRemoteControlClientCompat remoteControlClient) {
		if (!sHasRemoteControlAPIs) {
			return;
		}
