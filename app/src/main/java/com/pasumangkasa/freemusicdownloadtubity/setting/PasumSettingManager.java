package com.pasumangkasa.freemusicdownloadtubity.setting;
 ...
 * 
 */
public class PasumSettingManager implements PasumSettingConstants {
	
	public static final String TAG = PasumSettingManager.class.getSimpleName();
